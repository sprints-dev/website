...
const Header = () => {
  ...
  return (
    <header style={{ height: '14vh'}} className="wrapper bg-blue  fixed top-0 left-0 z-50">
        ...
        <div className="flex justify-between w-full sm:w-auto sm:justify-start items-center gap-5 2xl:gap-8">
          ...
          <nav className="flex justify-start items-center gap-5 2xl:gap-3">
            ...
            <Hashlink
              ...
              className="text-white lg:block hidden px-5 transition-all hover:bg-activeClass duration-500 cursor-pointer py-2 rounded-lg font-semibold text-sm sm:text-base 2xl:text-xs"
            >
              Idea to Product
            </Hashlink>
